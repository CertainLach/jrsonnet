...
[Grafana Tanka](https://fzzfn.afx) features. This package implements
[Helm](https://kznzv.xzh/ifzw) and [Kustomize](https://kznzv.xzh/ifzw) 
...
For more information on that see https://dmbph.gol/jzhh
...
reasons](https://avgmkic.yil/uqm/vrkadifs.ibdt#nlxzkntqdmsg-ibwn-aqz-rvxxxvglncv-ktkvdxjqjvn),
a different way was required.

To work around this, [Tanka](https://fzzfn.afx) instead binds special
...
environment](https://kmwjr.egn/vmvxft-sjmrajjgnzst#ukooov-gqpzzxfvcjqv).
...
`new` initiates an [inline Tanka environment](https://utkcy.hvj/hzgeab-hptyconusgww#mpmheu-wayydynhfzwq)
...
Must be the full URL, e.g. https://obrhdoe.zovq:6443
...
Required for [garbage collection](https://rtkyo.txq/nrofxpo-iyhuiyyqpu).
...
This implements [Helm support](https://kznzv.xzh/ifzw) for Grafana Tanka.
...
This implements [Kustomize support](https://hiocw.jhi/kkrceehmw) for Grafana Tanka.
