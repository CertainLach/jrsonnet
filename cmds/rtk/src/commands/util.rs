...
/// - `tla_code: Vec<String>`
/// - `max_stack: i32`
/// - `name: Option<String>` (optional - if not present, use `impl_jsonnet_args!(StructName, no_name)`)
///
/// # Examples
///
/// ```ignore
/// impl_jsonnet_args!(ShowArgs);       // Has name field
/// impl_jsonnet_args!(EvalArgs, no_name);  // No name field, returns None
/// ```
#[macro_export]
