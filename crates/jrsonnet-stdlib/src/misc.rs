...
use jrsonnet_evaluator::{
	...
	val::{equals, ArrValue},
	Context, Either, IStr, ObjValue, ObjValueBuilder, ResultExt, State, Thunk, Val,
};
...
pub fn builtin_ext_var(this: &builtin_ext_var, state: State, x: IStr) -> Result<Val> {
	this.settings
		.borrow()
		.ext_vars
		.get(&x)
